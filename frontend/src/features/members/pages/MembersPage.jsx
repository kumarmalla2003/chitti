...
import MembersListReportPDF from "../components/MembersListReportPDF"; // Ensure this is moved or path is correct
...
const MembersPage = () => {
  ...
  // --- React Query Hooks ---
  const { data, isLoading: loading, error: queryError } = useMembers();
  ...
  const handlePrintMember = async (member) => {
    ...
    try {
        // Keeping manual fetch for complex report data aggregation for now
        ...
        <div className="pb-16 md:pb-0">
          <main className="flex-grow min-h-[calc(100vh-128px)] bg-background-primary px-4 py-8">
            <div className="container mx-auto">
              ...
              {!loading && !queryError && filteredMembers.length === 0 && (
